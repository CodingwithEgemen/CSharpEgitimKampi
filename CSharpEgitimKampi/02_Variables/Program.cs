...
namespace _02_Variables
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.WriteLine("Yolcu Ad soyad: " + passengerName + " " + passengerSurname + " " + " İl/İlçe: " + passengerCity + "/" + passengerDistrict + " " + "Yaş: "+ passengerAge + " " + "TC Kimlik: "+ passengerIdentityNumber);
